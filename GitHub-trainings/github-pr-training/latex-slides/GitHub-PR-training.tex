...
\begin{frame}
	...
	\begin{columns}[c]
		...
		A PR is a collaboration tool when working with branches.
        The intention of a PR is always to merge two branches, 
		but a PR adds excellent review features before the merge is done.
