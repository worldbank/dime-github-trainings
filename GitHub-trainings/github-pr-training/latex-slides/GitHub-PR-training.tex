...
\begin{frame}
	...
	\begin{columns}[c]
		...
		\begin{itemize}
			...
			\item Notify the assignee(s) using email 
...
\begin{frame}
	...
	\begin{columns}[c]
		...
		\begin{itemize}
			\setlength\itemsep{1em}
			\item The author accepts or discusses suggestions
...
\begin{frame}
	...
	\begin{minipage}[t][5cm][t]{\textwidth}
		\begin{itemize}
			...
			\item Split them up in as many tasks as needed
...
\begin{frame}
	...
	\begin{minipage}[t][5cm][t]{\textwidth}
		\begin{itemize}
			...
			approved in the review step in the work stage and
...
\begin{frame}
	...
	\begin{minipage}[t][5cm][t]{\textwidth}
		\begin{itemize}
			...
			also approved in the review step in the work stage and
			was merged and deleted in the merge stage
