...
\begin{frame}
	...
	\begin{columns}[c]
		...
		\begin{itemize}
			...
			\item They allow other team members to provide input on how to solve something
			\item You don't need to open an issue if the task will be done immediately and you don't need a place to record discussions about it
		\end{itemize}
