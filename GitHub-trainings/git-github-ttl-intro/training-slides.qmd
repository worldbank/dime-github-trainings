...
format:
  dime-revealjs:
    ...
    footer: "[DIME Analytics](https://www.worldbank.org/en/research/dime/data-and-analytics) - [Reproducible Research Repository](https://reproducibility.worldbank.org/) - [these slides](https://osf.io/92jtd)"
---
...
Every commit is on the project level. This means, a commit includes the difference in all project files relative the previous commit.
