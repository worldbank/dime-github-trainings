...
On your computer, the files in the clone of the repository will looks and behaves like a regular project folder. Work with the code files exactly how you usually do without Git.
...
Experiment with your code and discard test code only used in development with a click of a button.
:::
...
Therefore, our recommendation is simply: Git and GitHub is for code, not data. 

But where should we save and share data? We have identified 3 methods.
...
_Example use case:_ Any project where the data is fetched through APIs or in other ways directly in the code.

Write an API call that loads the data into working memory or saves it to file.
...
# Under-utilized great features on GitHub
