...
format:
  dime-revealjs:
    ...
    logo: "_extensions/dime/logos/WB-DEC-Impact-horizontal-RGB-high.png"
...
- Join the contributor training during MSFR on Friday, June 13 at 9am ET. MSFR agenda: https://bit.ly/msfr25-agenda
...
A Git Client is a software that allows you to package your edits into commits.
...
All code, regardless of language, is stored as raw text files. 

Formats like `.tex`, `.md`, and `.qmd` are also raw text.
